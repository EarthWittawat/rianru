...
![The reader: a lecture page with an explanation of the selected passage in the margin](docs/images/reader.jpg)

![The path: the course in teaching order, with a concept explained beside it](docs/images/path.jpg)

<p align="center">
  <em>Screenshots use DEMO101, a synthetic course generated by
  <code>scripts/make_demo_course.py</code>. Real course material is never committed.</em>
</p>
...
6. Describe your course material in `manifest.json` at the repository root. That
   ...
   To try the app without any material of your own, generate a synthetic course
   first and use the manifest entry it prints:
